...
import { GetRoomList, CreateRoom } from '../../redux/actions';
...
function RoomLayout({
    ...
    const createRoom = useCallback(() => dispatch(CreateRoom()), [dispatch]);
                        ...
                        Object.keys(groups).map((key) => (
                            <TouchableOpacity key={key} onPress={() => {
                                ...
                                <Card center middle shadow style={styles.category}>
                                    ...
                                    <Text googlemedium black height={30} style={styles.roomText}>{groups[key].name}</Text>
                                    <Text gray caption>{groups[key].lights.length} bulbs</Text>
                                </Card>
                            </TouchableOpacity>
                        ))
                }
